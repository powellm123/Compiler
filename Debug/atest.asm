...
# WRTC					#l121  
	...
	STB	R3	OUTPUT
	TRP	3	
# Boolean					#l147 K236 t358
WHILEBEGIN1	LDR	R3	l147
	MOV	R4	FP
	ADI	R4	-12
	LDR	R4	R4
	MOV	R5	FP
...
# Math					#l242 K236 t359
	...
	ADI	R4	-12
	LDR	R4	R4
	MUL	R4	R3			# DO Math Operation on 1000 and key
	MOV	R5	FP
	ADI	R5	-40
	STR	R4	R5
# Math					#t359 l162 t360
	...
	LDR	R3	R3
	LDR	R4	l162
	ADD	R4	R3			# DO Math Operation on t113 and 6
	MOV	R5	FP
	ADI	R5	-44
	STR	R4	R5
# Math					#l156 t360 t361
	...
	ADI	R4	-44
	LDR	R4	R4
	SUB	R4	R3			# DO Math Operation on 3 and t114
	MOV	R5	FP
	ADI	R5	-48
	STR	R4	R5
# FRAME					#F106 K237 
...
# PUSH					#t361  
	...
	ADI	R3	-48
	LDR	R3	R3
	STR	R3	SP			# Stores t115 into top of stack
	ADI	SP	-4
# CALL					#add(int)  
	MOV	R10	PC
	ADI	R10	21
